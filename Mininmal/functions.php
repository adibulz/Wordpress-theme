...
if ( ! function_exists( 'theme1_setup' ) ) :
	...
	function theme1_setup() {
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__( 'Primary', 'theme1' ),
			)
		);
...
function theme1_scripts() {
	wp_enqueue_style( 'theme1-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'theme1-style', 'rtl', 'replace' );

	wp_enqueue_script( 'theme1-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
